...
<header class="page-header" >
    <nav>
        ...
        <ul class="admin-menu">
            ...
            <li>
                <a href="Dashbord.php">
                   <!-- <img src="images/icon1removebg-preview.png" style="width: 40px;height: 40px" alt="" <a href="Dashbord.php"><div> Dashbord</div> </a>>
              -->
                    <svg>
            ...
            <li>
                <a href="viewtourpacage.php">
                    <svg>
                        <use xlink:href="#trends"></use>
                    </svg>
                    <span>Tourpacage</span>
                </a>
            </li>
...
<div>
    <section class="home-section"  >
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d867282.9563230028!2d35.550095929056354!3d31.884200679890043!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151cf2d28866bdd9%3A0xee17a001d166f686!2z2YHZhNiz2LfZitmG!5e0!3m2!1sar!2s!4v1683992215080!5m2!1sar!2s"    width="100%-78" height="850vh" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" "></iframe>
