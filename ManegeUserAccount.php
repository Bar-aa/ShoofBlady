...
<?php include 'changeuserpass.php'; ?>
...
<header class="global-header" id="top-nav">
            ...
            <li id="menu-1-button">Packeges  <svg class="arrow" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#454545" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
                ...
                <aside class="dropdown-menu" id="menu-1">
                    ...
                    <ul class="menu-item-list">
                        <li><a href="ManegeUserPackeges.php#Former">packages</a></li>
                        <!--li><a href="ManegeUserPackeges.php#Former">Former packages</a></li-->
                        <!--li><a href="ManegeUserPackeges.php#Upcoming">Upcoming packages</a></li-->
                    </ul>
                </aside>
            </li>
            <li id="menu-2-button">Update profile <svg class="arrow2" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#454545" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
                ...
                <aside class="dropdown-menu" id="menu-2">
                    <ul class="menu-item-list">
                        ...
                        <li><a href="#information">Update information</a></li>
                        <li><a href="deletemember.php">Delete account</a></li>
                    </ul>
                </aside>
            </li>
        </ul>
    ...
    <div class="nav-right">
        ...
        <p class="workspaces" id="my-paragraph"><a href="home.php" style="color: white">Go To Home</a><svg class="arrow5" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
        </p>
...
<aside class="side-menu-position side-menu-design" id="side-menu">
    ...
    <ul class="side-menu-content">
        ...
        <ul class="side-menu-item-list">
            <li><a href="ManegeUserPackeges.php#Update">Update packages</a></li>
            <li><a href="ManegeUserPackeges.php#Former">Former packages</a></li>
            <li><a href="ManegeUserPackeges.php#Upcoming">Upcoming packages</a></li>
        </ul>
